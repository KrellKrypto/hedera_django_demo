#these are the forms used by the user module 
#They fill the feilds required by the user models to create user objects 
...
class UserProfileForm(forms.ModelForm):
	...
	class Meta:
		model = UserProfile
		fields = ('telephone', 'address', 'town', 'state', 'post_code', )
